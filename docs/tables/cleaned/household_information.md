...
| Years     | ABDNAME   | ADDRESS   | BAKHSH   | BLKABD   | BLKABDJAYGOZIN   | FASL   | FENT   | FSTAT   | FVAM   | FVFY   | HOZEH   | ISTEL   | JAYGOZIN              | JAYGOZINDESC   | JAYGOZINDESC1   | JAYGOZINDESC2   | JAYGOZINDESCA   | JAYGOZINDESCB   | JAYGOZINDESCC   | MAHMORAJEH   | NAMESARPARAST   | NESHANISARPARAST   | NOEKHN         | RADIFJAYGOZIN   | SHOGHLSARPARAST   | SHRDEH   | TAKMIL         | TAKMILDESC   | TAKMILDESCA   | TAKMILDESCB   | TAKMILDESCC   | TEKRARI   | USER1   | USER2   | USER3   | USER4   | WEIGHT   |
|:----------|:----------|:----------|:---------|:---------|:-----------------|:-------|:-------|:--------|:-------|:-------|:--------|:--------|:----------------------|:---------------|:----------------|:----------------|:----------------|:----------------|:----------------|:-------------|:----------------|:-------------------|:---------------|:----------------|:------------------|:---------|:---------------|:-------------|:--------------|:--------------|:--------------|:----------|:--------|:--------|:--------|:--------|:---------|
| 1387-1388 |           | ID        |          |          | drop             |        | drop   | drop    |        | drop   |         |         | Alternative_Household | drop           |                 |                 |                 |                 |                 | Month        | drop            | drop               | Household_Type | drop            | drop              |          | Main_Household | drop         |               |               |               |           | drop    | drop    | drop    | drop    |          |
| 1389      |           | ID        |          |          | drop             |        | drop   | drop    |        | drop   |         |         | Alternative_Household |                | drop            | drop            |                 |                 |                 | Month        |                 |                    | Household_Type | drop            | drop              |          | Main_Household | drop         |               |               |               |           | drop    | drop    | drop    | drop    |          |
| 1390      |           | ID        |          |          | drop             |        | drop   | drop    |        | drop   |         |         | Alternative_Household |                |                 |                 | drop            | drop            | drop            | Month        |                 |                    | Household_Type | drop            | drop              |          | Main_Household |              | drop          | drop          | drop          |           | drop    | drop    | drop    | drop    |          |
| 1391      |           | ID        |          |          | drop             |        | drop   | drop    |        | drop   |         |         | Alternative_Household |                |                 |                 | drop            | drop            | drop            | Month        |                 |                    | Household_Type | drop            | drop              |          | Main_Household |              | drop          | drop          | drop          | drop      | drop    | drop    | drop    | drop    |          |
| 1392-1395 | drop      | ID        | drop     | drop     | drop             |        | drop   | drop    |        | drop   | drop    |         | Alternative_Household |                |                 |                 | drop            | drop            | drop            | Month        |                 |                    | Household_Type | drop            | drop              | drop     | Main_Household |              | drop          | drop          | drop          | drop      | drop    | drop    | drop    | drop    |          |
...
| Years     | ID      | Season   | Alternative_Household   | Household_Type   | Main_Household   | Weight   | Month      |
|:----------|:--------|:---------|:------------------------|:-----------------|:-----------------|:---------|:-----------|
