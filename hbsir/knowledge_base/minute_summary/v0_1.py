...
def fillna_with_false(df: pd.DataFrame) -> pd.DataFrame:
    df.loc[:, "Car":"Elevator"] = df.loc[:, "Car":"Elevator"].fillna(False)
    return df
...
def create_styled_table(year: int):
    ...
    styled_df = (
        ...
        .set_properties(
            tables[0].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[1].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[2].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[3].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[4].columns.map(lambda n: n.replace("_", " ")),
            **{
                "background-color": "#DCE6F1",
                "border": "1px solid #95B3D7",
            }
        ...
        .set_properties(
            tables[5].columns.map(lambda n: n.replace("_", " ")),
            **{
                "background-color": "#B8CCE4",
                "border": "1px solid #95B3D7",
            }
        ...
        .set_properties(
            tables[6].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[7].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[8].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[9].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[10].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[11].columns.map(lambda n: n.replace("_", " ")),
            **{
        ...
        .set_properties(
            tables[12].columns.map(lambda n: n.replace("_", " ")),
            **{
...
def main(year: int) -> None:
    styled_df = create_styled_table(year=1402)
    styled_df.to_excel(f"Minute_Summary_{year}.xlsx", merge_cells=False, index=False)
